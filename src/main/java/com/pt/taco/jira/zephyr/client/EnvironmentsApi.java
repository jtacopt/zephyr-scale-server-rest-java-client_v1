...
public class EnvironmentsApi {
    ...
    public static EnvironmentsApi environments(Supplier<RequestSpecBuilder> reqSpecSupplier) {
        return new EnvironmentsApi(reqSpecSupplier);
    }
    ...
    public CreateEnvironmentsOper createEnvironments() {
        return new CreateEnvironmentsOper(createReqSpec());
    }

    public GetEnvironmentsOper getEnvironments() {
        return new GetEnvironmentsOper(createReqSpec());
    }
     ...
     * @return api
     */
    public EnvironmentsApi reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
    ...
    public static class CreateEnvironmentsOper implements Oper {
         ...
         * @return operation
         */
        public CreateEnvironmentsOper body(String body) {
         ...
         * @return operation
         */
        public CreateEnvironmentsOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public CreateEnvironmentsOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
    ...
    /**
     * Retrieve the Environments matching the given projectKey.  The project must exist The project must have Zephyr Scale enabled
     *
     * @see #projectKeyQuery The key of the Project (required)
     * return Object
     */
    public static class GetEnvironmentsOper implements Oper {
         ...
         * @return operation
         */
        public GetEnvironmentsOper projectKeyQuery(Object... projectKey) {
            reqSpec.addQueryParam(PROJECT_KEY_QUERY, projectKey);
            return this;
        }
         ...
         * @return operation
         */
        public GetEnvironmentsOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public GetEnvironmentsOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
