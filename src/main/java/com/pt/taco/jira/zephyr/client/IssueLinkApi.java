...
public class IssueLinkApi {
    ...
    public static IssueLinkApi issueLink(Supplier<RequestSpecBuilder> reqSpecSupplier) {
        return new IssueLinkApi(reqSpecSupplier);
    }
    ...
    public GetIssueLinkByIssueKeyOper getIssueLinkByIssueKey() {
        return new GetIssueLinkByIssueKeyOper(createReqSpec());
    }
     ...
     * @return api
     */
    public IssueLinkApi reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
     ...
     *
     * @see #issueKeyPath The key of the linked Issue. (required)
    ...
    public static class GetIssueLinkByIssueKeyOper implements Oper {
        ...
        /**
         * GET /issuelink/{issueKey}/testcases
         *
        ...
        /**
         * @param issueKey (String) The key of the linked Issue. (required)
         * @return operation
         */
        public GetIssueLinkByIssueKeyOper issueKeyPath(Object issueKey) {
            reqSpec.addPathParam(ISSUE_KEY_PATH, issueKey);
            return this;
        }
         ...
         * @return operation
         */
        public GetIssueLinkByIssueKeyOper fieldsQuery(Object... fields) {
         ...
         * @return operation
         */
        public GetIssueLinkByIssueKeyOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public GetIssueLinkByIssueKeyOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
