...
public class FolderApi {
    ...
    public static FolderApi folder(Supplier<RequestSpecBuilder> reqSpecSupplier) {
        return new FolderApi(reqSpecSupplier);
    }
    ...
    public CreateFolderOper createFolder() {
        return new CreateFolderOper(createReqSpec());
    }

    public UpdateFolderByFolderIdOper updateFolderByFolderId() {
        return new UpdateFolderByFolderIdOper(createReqSpec());
    }
     ...
     * @return api
     */
    public FolderApi reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
        this.reqSpecCustomizer = reqSpecCustomizer;
        return this;
    }

    /**
     * Creates a new folder for test cases, test plans or test runs.  In order to create a new folder you must POST a json with 3 fields: projectKey, name and type. The field type can be filled with TEST_CASE, TEST_PLAN or TEST_RUN.
     *
     * @see #body  (optional)
     * return Object
     */
    public static class CreateFolderOper implements Oper {
         ...
         * @return operation
         */
        public CreateFolderOper body(String body) {
         ...
         * @return operation
         */
        public CreateFolderOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public CreateFolderOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
    ...
    public static class UpdateFolderByFolderIdOper implements Oper {
         ...
         * @return operation
         */
        public UpdateFolderByFolderIdOper body(String body) {
            reqSpec.setBody(body);
            return this;
        }

        /**
         * @param folderId (Integer) The id of the Folder. (required)
         * @return operation
         */
        public UpdateFolderByFolderIdOper folderIdPath(Object folderId) {
            reqSpec.addPathParam(FOLDER_ID_PATH, folderId);
            return this;
        }
         ...
         * @return operation
         */
        public UpdateFolderByFolderIdOper reqSpec(Consumer<RequestSpecBuilder> reqSpecCustomizer) {
            reqSpecCustomizer.accept(reqSpec);
            return this;
        }
         ...
         * @return operation
         */
        public UpdateFolderByFolderIdOper respSpec(Consumer<ResponseSpecBuilder> respSpecCustomizer) {
            respSpecCustomizer.accept(respSpec);
            return this;
        }
    }
