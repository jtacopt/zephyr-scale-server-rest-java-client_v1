...
public class Parameter {
    ...
    public Parameter variables(List<Variable> variables) {

        this.variables = variables;
        return this;
    }

    public Parameter addVariablesItem(Variable variablesItem) {
    ...
    public Parameter entries(List<Map<String, String>> entries) {

        this.entries = entries;
        return this;
    }

    public Parameter addEntriesItem(Map<String, String> entriesItem) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.variables, parameter.variables) &&
                Objects.equals(this.entries, parameter.entries);
    }

    @Override
    public int hashCode() {
        return Objects.hash(variables, entries);
    }
